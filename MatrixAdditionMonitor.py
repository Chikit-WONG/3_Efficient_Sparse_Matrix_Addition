...
def matrix_addition_with_monitor(input1, input2, output2, rows, cols):
    ...
    # 监控矩阵加法性能
    (result_matrix, elapsed_time, peak_memory) = monitor_memory_and_time(
        add_sparse_matrices, rows1, cols1, matrix1, matrix2
    )

    # 写入 output2.txt
    write_sparse_matrix(output2, rows1, cols1, result_matrix)
